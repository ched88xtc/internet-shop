				...
				<Grid.Col span="content" className={classes.formAndButtonContainer}>
                  ...
                  className={classes.inputWrapper}
                    ...
                    icon={<IconUserCircle/>}
									...
									/>
                  {errors?.firstName && (
                    <span className={classes.spanError}>{errors.firstName.message?.toString()}</span>
                  )}
								</Input.Wrapper>
								<Input.Wrapper
                  className={classes.inputWrapper}
                    ...
                    icon={<IconUserCircle/>}
									...
									/>
                  {errors?.lastName && (
                    <span className={classes.spanError}>{errors.lastName.message?.toString()}</span>
                  )}
								</Input.Wrapper>
								<Input.Wrapper
                  className={classes.inputWrapper}
                    ...
                    icon={<IconMap2/>}
									...
									/>
                  {errors?.address && (
                    <span className={classes.spanError}>{errors.address.message?.toString()}</span>
                  )}
								</Input.Wrapper>
								<Input.Wrapper
                  className={classes.inputWrapper}
                    ...
                    icon={<IconPhone/>}
									...
									/>
                  {errors?.phone && (
                    <span className={classes.spanError}>{errors.phone.message?.toString()}</span>
                  )}
								</Input.Wrapper>
                <Input.Wrapper
                  className={classes.inputWrapper}
                    ...
                    icon={<IconAt/>}
									...
									/>
                  {errors?.email && (
                    <span className={classes.spanError}>{errors.email.message?.toString()}</span>
                  )}
								</Input.Wrapper>
								<input className={classes.submitBtn} type="submit" value="Order"/>
							</form>
						</Container>
